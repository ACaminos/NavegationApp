...
export type RootStackParams = { //Esto hace que cualquier agregado o modificacion que se haga en stack.screen, sea rechazado, o mejor dicho, que de error. Si se queire agregar algo, sera desde aca.
